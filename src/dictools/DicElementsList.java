...
public class DicElementsList {
    ...
    private List<String> processListE(String stem, String parname)
    {
         List<StringBuilder> listgeneratedByElement=new LinkedList<StringBuilder>();
         listgeneratedByElement.add(new StringBuilder(""));

         List<E> parElements=dic.pardefs.getParadigmDefinition(parname).elements;
    ...
    private void expandElement() {
        List<String> formlist=processListE(this.stem, this.paradigm);
