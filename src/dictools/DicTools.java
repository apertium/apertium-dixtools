...
public class DicTools {
    ...
    /**
         ...
         * @return
         */
    public static String getTextValue(final ElementList children) {
	String text = "";
	for (final Element e : children) {
	    if (e instanceof TextElement) {
		text += ((TextElement) e).getValue();
	    }
    ...
    /**
         ...
         * @return
         */
    public static final boolean containsCategory(final String category,
	    final EElementList v) {
	for (final EElement e : v) {
	    if (e.is("L", category)) {
		return true;
	    }
	}
    ...
    /**
         ...
         * @return
         */
    public static final EElement getEElementByCategory(final String side,
	    final EElementList v, final String category) {
	for (final EElement e : v) {
	    if (e.is("L", category)) {
		return e;
	    }
    ...
    /**
         ...
         * @return
         */
    public static final boolean checkCategory(final String category,
	    final EElement e1, final EElement e2) {
	final boolean c1 = e1.is("L", category);
	final boolean c2 = e2.is("L", category);
	return (c1 && c2);
    }
    ...
    /**
         ...
         * @return
         */
    public static EElement getEquivalent(final EElementList v,
    ...
    /**
         ...
         * @return
         */
    public static EElementList getEquivalents(final EElementList v,
	    final String category) {
	final EElementList eList = new EElementList();
    ...
    /**
         ...
         * @return
         */
    public static final SElementList getLongestCategory(final String side,
	    final EElement e1, final EElement e2) {
	if (e1.getSElements(side).size() > e2.getSElements(side).size()) {
	    return e1.getSElements(side);
	} else {
	    return e2.getSElements(side);
	}
    }
    ...
    /**
         ...
         * @return
         */
    public static final EElement getLongestCategoryElement(final String side,
	    final EElement e1, final EElement e2) {
	if (e1.getSElements(side).size() > e2.getSElements(side).size()) {
	    return e1;
	} else {
    ...
    /**
         ...
         * @return
         */
    public static final EElement getShortestCategoryElement(final String side,
	    final EElement e1, final EElement e2) {
	if (e1.getSElements(side).size() < e2.getSElements(side).size()) {
	    return e1;
	} else {
    ...
    /**
         ...
         * @return
         */
    public static String getTranslation(final EElementList v,
	    final String category) {
	for (final EElement e : v) {
	    if (e.is("R", category)) {
		return e.getValue("R");
     ...
     * @return
     */
    public static final DicSet makeConsistentBilAndMonols(DictionaryElement bilAB, DictionaryElement monA, DictionaryElement monC) {
	final EElementList[] commonCrossedMons = DicTools.makeConsistent(bilAB, monA, monC);
