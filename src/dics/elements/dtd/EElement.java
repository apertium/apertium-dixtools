...
public class EElement extends Element implements Cloneable,
	...
	if (r == null) {
	    ...
	    if (r.equals("LR") || r.equals("RL") || r.equals("BOTH")) {
		return true;
	    }
	}
	return false;
	...
	for (final SElement s : elements) {
	    System.err.print(s.getValue() + " ");
	}
	}
    }

    public final void print(final String side) {
	System.err.print(this.getSide(side).getValue() + " / ");
	this.printSElements(side);
	System.err.println("");
    }
	...
	SElementList sEList1L = this.getSElements("L");
	SElementList sEList2L = e2.getSElements("L");
	
	SElementList sEList1R = this.getSElements("R");
	SElementList sEList2R = e2.getSElements("R");
	
	if ( sEList1L != null && sEList2L != null) {
	    /*
	System.err.println("Comparing left side...");
	sEList1L.print();
	sEList2L.print();
	*/
	...
	if ( sEList1R != null && sEList2R != null) {
	    /*
	System.err.println("Comparing right side...");
	sEList1R.print();
	sEList2R.print();
	*/
