...
public class DicSet {
	...
	System.err.println(mon1.getEntries().size()
		+ " entradas en el diccionario monolinge es-ca");
	System.err.println(mon2.getEntries().size()
		+ " entradas en el diccionario monolinge es-pt");
	System.err.println(bil1.getEntries().size()
		+ " entradas en el diccionario bilinge es-ca");
	System.err.println(bil2.getEntries().size()
		+ " entradas en el diccionario bilinge es-pt");
    }
