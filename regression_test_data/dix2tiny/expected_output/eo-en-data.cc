...
kvar {num} :: four {num} 
kvin {num} :: five {num} 
dek unu {num} :: eleven {num} 
dek du {num} :: twelve {num} 
dek tri {num} :: thirteen {num} 
dek kvar {num} :: fourteen {num} 
dek kvin {num} :: fifteen {num} 
dudek {num} :: twenty {num} 
